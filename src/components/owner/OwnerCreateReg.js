...
class OwnerCreateReg extends React.Component {
  state = {
    user_name: '',
    pw: '',
    reg_type: 'wedding',
...
const OwnerCreateRegConnect = connect(null, mapDispatchToProps)(OwnerCreateReg)

export default withStyles(styles)(OwnerCreateRegConnect);
